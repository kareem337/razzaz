  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="d-flex">
        ...
        <a href="https://www.youtube.com/watch?v=aaExiKsvt9A" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true" style="text-decoration: none;"> Watch Video <i class="icofont-play-alt-2"></i></a>
      </div>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-end">
              ...
              <div class="col-lg-3 col-md-5 col-6 d-md-flex align-items-md-stretch">
                <div class="count-box">
                  ...
                  <span style = 'font-size: 18px;' data-toggle="">Serendipity</span>
                  <p> Happy tours</p>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 video-box align-self-baseline" data-aos="zoom-in" data-aos-delay="100">
            <img src="assets/img/vid.jpg" class="img-fluid" alt="">
            <a href="https://www.youtube.com/watch?v=MyqhDKNig88" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">For us quality of experience is only second to safety.
We are committed to providing world-class trekking experiences for our guests that go way above and beyond the mass-produced tours so common today. </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              <img src="assets/img/Plan.png" class="card-img-top" alt="...">
              <div class="card-icon">
                <i class="ri-calendar-check-line"></i>
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Our Plan</a></h5>
                <p class="card-text">Razzaz Tours intends to provide individual and group travel to leisure clients. Services and products provided by Razzaz Tours will initially include pre-arranged tours and custom packages to our clients.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Being part of the exclusive leaders in Egypt’s tourism sector by the year 2024; as well as being recognized for the quality of our services and the contribution that we make to the development of our country.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-8">
            <div class="footer-info">
              ...
              <p>
                Marouf Street <br>
                Qasr El Nil, Egypt<br><br>
                <strong>Phone:</strong> 0100100100<br>
                <strong>Email:</strong> Razzaz-Tours@gmail.com<br>
              </p>
